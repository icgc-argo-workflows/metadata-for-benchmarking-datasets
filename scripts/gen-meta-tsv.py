...
def migrate_specimen_type(old_specimen_type):
    specimen_type_mapping = {
        ...
        'Metastatic tumour - lymph node': ['Tumour', 'Metastatic tumour - metastasis local to lymph node', 'Lymph node'],
        ...
        'Normal - EBV immortalized': ['Normal', 'Cell line - derived from normal', 'Other'],
        ...
        'Normal - tissue adjacent to primary': ['Normal', 'Normal', 'Normal - tissue adjacent to primary tumour'],
